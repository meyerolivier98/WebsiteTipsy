    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption">
                ...
                <a href="index.php"><button type="button" class="btn btn-primary btn-lg"><i class="fas fa-sign-in-alt"></i>Login</button></a>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="carousel-caption">
                ...
                <a href="Dashboard.php"><button type="button" class="btn btn-primary btn-lg"><i class="fas fa-sign-in-alt"></i>Dashboard</button></a>
            </div>
        </div>
    </div>
</div>
